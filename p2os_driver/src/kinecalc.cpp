/*
 *  P2OS for ROS
 *  Copyright (C) 2015  David Feil-Seifer, Brian Gerkey, Kasper Stoy,
...
#include <p2os_driver/kinecalc.hpp>
...
EndEffector KineCalc::CalcFKForJoints(const double angles[])
{
  ...
  result.p.x = link5 *
    ((cos1 * cos23 * cos5) + (sin1 * sin4 * sin5) - (cos1 * sin23 * cos4 * sin5)) +
    cos1 * ((link4 * cos23) + (link2 * cos2) + link1);
  result.p.y = link5 *
    ((sin1 * cos23 * cos5) + (cos1 * sin4 * sin5) - (sin1 * sin23 * cos4 * sin5)) +
